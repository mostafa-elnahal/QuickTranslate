...
public partial class PopupViewModel : ObservableObject, IDisposable
{
    ...
    public double DictionaryTermFontSize => TranslationFontSize * 0.80;
    public double DictionarySmallFontSize => TranslationFontSize * 0.75;
    public double ChevronHeight => DictionarySmallFontSize * 0.75;
    public double ChevronWidth => ChevronHeight * 0.66;
    public double ChevronStrokeThickness => Math.Max(1.0, DictionarySmallFontSize * 0.12);
    ...
    public double PronunciationFontSize => TranslationFontSize * 1.5;
